...
GRANT CREATE AGENT ON SCHEMA CHURN_AGENT_DB.AGENTS TO ROLE CHURN_AGENT_ROLE;
...
SELECT 'Setup complete! Agent CHURN_AGENT_DB.AGENTS.CUSTOMER_CHURN_MODELING is ready and can be viewed at Cortex AI -> Agents. Ensure your role has been changed to CHURN_AGENT_ROLE in Snowsight.' AS STATUS;
